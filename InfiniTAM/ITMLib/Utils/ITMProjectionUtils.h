...
template<typename T>
_CPU_AND_GPU_CODE_ inline Vector2f project(const THREADPTR(ORUtils::Vector3<T>) &point_3d,
...
template<typename T>
_CPU_AND_GPU_CODE_ inline Vector3f unproject(const THREADPTR(ORUtils::Vector2<T>) &point_2d,
                                             const THREADPTR(float) depth,
                                             const THREADPTR(Vector4f) &intrinsics) {
...
template<typename T>
_CPU_AND_GPU_CODE_ inline Vector3f unproject(const THREADPTR(T) x,
                                             const THREADPTR(T) y,
                                             const THREADPTR(float) depth,
                                             const THREADPTR(Vector4f) &intrinsics) {
