...
_CPU_AND_GPU_CODE_ inline float getColorDifferenceSq(DEVICEPTR(Vector4f) *locations,
                                                     DEVICEPTR(Vector4f) *colours,
                                                     DEVICEPTR(Vector4u) *rgb,
...
_CPU_AND_GPU_CODE_ inline bool computePerPointGH_rt_Color(THREADPTR(float) *localGradient,
                                                          ...
                                                          Vector4f projParams,
                                                          Matrix4f M,
                                                          DEVICEPTR(Vector4s) *gx,
                                                          DEVICEPTR(Vector4s) *gy,
                                                          int numPara,
                                                          int startPara) {
