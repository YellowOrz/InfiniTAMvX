...
__global__ void colorTrackerOneLevel_f_device(Vector2f *out,
                                              Vector4f *locations,
                                              Vector4f *colours,
                                              Vector4u *rgb,
                                              int noTotalPoints,
...
__global__ void colorTrackerOneLevel_g_rt_device(float *g_out,
                                                 float *h_out,
                                                 Vector4f *locations,
                                                 Vector4f *colours,
                                                 Vector4s *gx,
                                                 ...
                                                 Vector4f projParams,
                                                 Vector2i imgSize);
__global__ void colorTrackerOneLevel_g_ro_device(float *g_out,
                                                 float *h_out,
                                                 Vector4f *locations,
                                                 Vector4f *colours,
                                                 Vector4s *gx,
...
ITMColorTracker_CUDA::ITMColorTracker_CUDA(Vector2i imgSize,
