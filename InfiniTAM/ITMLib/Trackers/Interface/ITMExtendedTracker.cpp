...
ITMExtendedTracker::ITMExtendedTracker(Vector2i imgSize_d,
  ...
  if (useDepth) {
    sceneHierarchy =
        new ITMImageHierarchy<ITMSceneHierarchyLevel>(imgSize_d, trackingRegime, noHierarchyLevels, memoryType, true);
  }
...
void ITMExtendedTracker::SetupLevels(int numIterCoarse,
                                     int numIterFine,
                                     float spaceThreshCoarse,
                                     float spaceThreshFine,
                                     float colourThreshCoarse,
                                     float colourThreshFine) {
