...
void ITMColorTracker::ApplyDelta(const ORUtils::SE3Pose &para_old,
                                 const float *delta,
                                 ORUtils::SE3Pose &para_new) const {
  float paramVector[6];

  switch (iterationType) {
    case TRACKER_ITERATION_ROTATION: paramVector[0] = 0.0f;
      paramVector[1] = 0.0f;
      paramVector[2] = 0.0f;
      ...
      break;
    case TRACKER_ITERATION_TRANSLATION: paramVector[0] = (float) (delta[0]);
      ...
      paramVector[5] = 0.0f;
      break;
    case TRACKER_ITERATION_BOTH: paramVector[0] = (float) (delta[0]);
      paramVector[1] = (float) (delta[1]);
      paramVector[2] = (float) (delta[2]);
...
static inline double stepQuality(ITMColorTracker::EvaluationPoint *x,
                                 ITMColorTracker::EvaluationPoint *x2,
                                 const float *step,
                                 const float *grad,
                                 const float *B,
                                 int numPara) {
