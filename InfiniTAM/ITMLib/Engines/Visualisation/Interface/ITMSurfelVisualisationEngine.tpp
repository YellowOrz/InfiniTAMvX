...
template<typename TSurfel>
void ITMSurfelVisualisationEngine<TSurfel>::FindSurface(const ITMSurfelScene<TSurfel> *scene,
...
template<typename TSurfel>
void ITMSurfelVisualisationEngine<TSurfel>::FindSurfaceSuper(const ITMSurfelScene<TSurfel> *scene,
                                                             const ORUtils::SE3Pose *pose,
                                                             const ITMIntrinsics *intrinsics,
                                                             UnstableSurfelRenderingMode unstableSurfelRenderingMode,
                                                             ITMSurfelRenderState *renderState) const {
