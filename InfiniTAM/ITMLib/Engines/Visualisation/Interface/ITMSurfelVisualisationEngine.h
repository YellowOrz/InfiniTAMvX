...
class ITMSurfelVisualisationEngine {
 ...
 public:
   ...
   */
  virtual void CopyCorrespondencesToBuffers(const ITMSurfelScene<TSurfel> *scene,
                                            float *newPositions,
                                            float *oldPositions,
   ...
   */
  virtual void CopySceneToBuffers(const ITMSurfelScene<TSurfel> *scene,
                                  float *positions,
   ...
   */
  virtual void CreateICPMaps(const ITMSurfelScene<TSurfel> *scene,
   ...
   */
  virtual void RenderDepthImage(const ITMSurfelScene<TSurfel> *scene,
   ...
   */
  virtual void RenderImage(const ITMSurfelScene<TSurfel> *scene,
                           const ORUtils::SE3Pose *pose,
                           const ITMSurfelRenderState *renderState,
                           ITMUChar4Image *outputImage,
                           RenderImageType type = RENDER_LAMBERTIAN) const = 0;
 ...
 public:
   ...
   */
  void FindSurface(const ITMSurfelScene<TSurfel> *scene,
                   const ORUtils::SE3Pose *pose,
   ...
   * \param renderState                   The render state in which to store the index image.
   */
  void FindSurfaceSuper(const ITMSurfelScene<TSurfel> *scene,
                        const ORUtils::SE3Pose *pose,
                        const ITMIntrinsics *intrinsics,
                        UnstableSurfelRenderingMode unstableSurfelRenderingMode,
                        ITMSurfelRenderState *renderState) const;
 ...
 private:
   ...
   */
  virtual void MakeIndexImage(const ITMSurfelScene<TSurfel> *scene,
                              const ORUtils::SE3Pose *pose,
                              const ITMIntrinsics *intrinsics,
                              int width,
                              int height,
