...
void ITMSurfelVisualisationEngine_CPU<TSurfel>::CopyCorrespondencesToBuffers(const ITMSurfelScene<TSurfel> *scene,
                                                                             float *newPositions,
                                                                             float *oldPositions,
...
template<typename TSurfel>
void ITMSurfelVisualisationEngine_CPU<TSurfel>::CopySceneToBuffers(const ITMSurfelScene<TSurfel> *scene,
                                                                   float *positions,
...
template<typename TSurfel>
void ITMSurfelVisualisationEngine_CPU<TSurfel>::CreateICPMaps(const ITMSurfelScene<TSurfel> *scene,
...
#pragma omp parallel for
  ...
  for (int locId = 0; locId < pixelCount; ++locId) {
    copy_surfel_data_to_icp_maps(locId,
                                 surfels,
                                 surfelIndexImage,
                                 invT,
...
template<typename TSurfel>
void ITMSurfelVisualisationEngine_CPU<TSurfel>::RenderDepthImage(const ITMSurfelScene<TSurfel> *scene,
...
template<typename TSurfel>
void ITMSurfelVisualisationEngine_CPU<TSurfel>::RenderImage(const ITMSurfelScene<TSurfel> *scene,
                                                            const ORUtils::SE3Pose *pose,
                                                            const ITMSurfelRenderState *renderState,
...
template<typename TSurfel>
void ITMSurfelVisualisationEngine_CPU<TSurfel>::MakeIndexImage(const ITMSurfelScene<TSurfel> *scene,
                                                               const ORUtils::SE3Pose *pose,
