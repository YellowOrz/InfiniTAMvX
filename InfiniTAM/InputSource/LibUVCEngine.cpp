...
void LibUVCEngine::getImages(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage) { return; }
bool LibUVCEngine::hasMoreImages(void) const { return false; }
Vector2i LibUVCEngine::getDepthImageSize(void) const { return Vector2i(0, 0); }
Vector2i LibUVCEngine::getRGBImageSize(void) const { return Vector2i(0, 0); }
