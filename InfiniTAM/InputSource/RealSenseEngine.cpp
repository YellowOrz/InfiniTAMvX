...
RealSenseEngine::~RealSenseEngine() {}
void RealSenseEngine::getImages(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage) { return; }
bool RealSenseEngine::hasMoreImages(void) const { return false; }
Vector2i RealSenseEngine::getDepthImageSize(void) const { return Vector2i(0, 0); }
Vector2i RealSenseEngine::getRGBImageSize(void) const { return Vector2i(0, 0); }
