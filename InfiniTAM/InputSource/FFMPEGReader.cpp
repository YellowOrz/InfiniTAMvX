...
FFMPEGReader::~FFMPEGReader(void) {}
void FFMPEGReader::getImages(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage) { return; }
bool FFMPEGReader::hasMoreImages(void) const { return false; }
Vector2i FFMPEGReader::getDepthImageSize(void) const { return Vector2i(0, 0); }
Vector2i FFMPEGReader::getRGBImageSize(void) const { return Vector2i(0, 0); }
