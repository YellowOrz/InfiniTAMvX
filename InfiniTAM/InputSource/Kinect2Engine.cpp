...
Kinect2Engine::~Kinect2Engine() {}
void Kinect2Engine::getImages(ITMUChar4Image *rgbImage, ITMShortImage *rawDepthImage) { return; }
bool Kinect2Engine::hasMoreImages(void) const { return false; }
Vector2i Kinect2Engine::getDepthImageSize(void) const { return Vector2i(0, 0); }
Vector2i Kinect2Engine::getRGBImageSize(void) const { return Vector2i(0, 0); }
