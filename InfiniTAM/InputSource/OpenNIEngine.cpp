...
static openni::VideoMode findBestMode(const openni::SensorInfo *sensorInfo,
...
OpenNIEngine::OpenNIEngine(const char *calibFilename, const char *deviceURI, const bool useInternalCalibration,
  ...
  if (rc == openni::STATUS_OK) {
    openni::VideoMode depthMode = findBestMode(data->device.getSensorInfo(openni::SENSOR_DEPTH),
                                               requested_imageSize_d.x,
                                               requested_imageSize_d.y,
  ...
  if (rc == openni::STATUS_OK) {
    openni::VideoMode colourMode = findBestMode(data->device.getSensorInfo(openni::SENSOR_COLOR),
                                                requested_imageSize_rgb.x,
                                                requested_imageSize_rgb.y);
...
OpenNIEngine::OpenNIEngine(const char *calibFilename,
                           const char *deviceURI,
                           const bool useInternalCalibration,
...
bool OpenNIEngine::hasMoreImages(void) const { return false; }
Vector2i OpenNIEngine::getDepthImageSize(void) const { return Vector2i(0, 0); }
Vector2i OpenNIEngine::getRGBImageSize(void) const { return Vector2i(0, 0); }
