...
bool FFMPEGWriter::writeFrame(ITMUChar4Image *rgbImage) { return false; }
bool FFMPEGWriter::writeFrame(ITMShortImage *depthImage) { return false; }
bool FFMPEGWriter::close(void) { return false; }
bool FFMPEGWriter::isOpen(void) const { return false; }
