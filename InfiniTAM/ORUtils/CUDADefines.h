...
// For debugging purposes   因为cuda检查要耗时
// #define ORcudaKernelCheck { cudaDeviceSynchronize(); ORUtils::__cudaSafeCall(cudaPeekAtLastError(), __FILE__,
// __LINE__); }
#endif

#endif  // COMPILE_WITHOUT_CUDA
